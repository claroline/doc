...
**Autoriser l'édition personnelle** vous permet de d'activer ou de désactiver la possibilité qu'un utilisateur éditer ses propres fiches.

**Modération des fiches** vous permet de déterminer si un gestionnaire (de la ressource ou d'une catégorie) doit valider la fiche avant qu'elle soit consultable.
